...
add column IgnoreCheckMinOrder tinyint(1) unsigned
;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		IgnoreCheckMinOrder = OLD.IgnoreCheckMinOrder;
END;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		IgnoreCheckMinOrder = NULLIF(NEW.IgnoreCheckMinOrder, OLD.IgnoreCheckMinOrder);
END;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		IgnoreCheckMinOrder = NEW.IgnoreCheckMinOrder;
END;
