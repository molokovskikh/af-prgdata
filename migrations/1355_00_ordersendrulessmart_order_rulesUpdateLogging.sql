...
add column DoNotSplitQuantity tinyint(1) unsigned,
add column MaxSplitQuantityPercent int(10) unsigned
;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		DoNotSplitQuantity = OLD.DoNotSplitQuantity,
		MaxSplitQuantityPercent = OLD.MaxSplitQuantityPercent;
END;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		DoNotSplitQuantity = NULLIF(NEW.DoNotSplitQuantity, OLD.DoNotSplitQuantity),
		MaxSplitQuantityPercent = NULLIF(NEW.MaxSplitQuantityPercent, OLD.MaxSplitQuantityPercent);
END;
...
FOR EACH ROW BEGIN
	...
	SET LogTime = now(),
		...
		DoNotSplitQuantity = NEW.DoNotSplitQuantity,
		MaxSplitQuantityPercent = NEW.MaxSplitQuantityPercent;
END;
